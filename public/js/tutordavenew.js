    ...
    for (let y = 0; y < data.length; y++) {
        ...
        if (tutorReviews !== null) {
            for (let s = 0; s < tutorReviews.length; s++) {
                ...
                let reviewer = tutorReviews[s].student_id
                        ...
                        <div class="card">
                            <nav>
                                <div class="nav nav-tabs card-header p-2" style="justify-content: ene;" id="${tutorName}-tabNav" role="tablist">
                                    <button class="nav-link active p-2 tutor-detail-tabs" style="max-width: 33%; font-size: 0.87rem;" id="${tutorName}-infoTab" data-bs-toggle="tab" data-bs-target="#${tutorName}-infoTabContent" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Basic Info</button>
                                    <button class="nav-link p-2 tutor-detail-tabs" style="max-width: 33%; font-size: 0.87rem;" id="${tutorName}-reviewsTab" data-bs-toggle="tab" data-bs-target="#${tutorName}-reviewsTabContent" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Reviews</button>
                                    <button class="nav-link p-2 tutor-detail-tabs" style="max-width: 33%; font-size: 0.87rem;" id="${tutorName}-contactTab" data-bs-toggle="tab" data-bs-target="#${tutorName}-contactTabContent" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Contact</button>
                                </div>
                            </nav>
