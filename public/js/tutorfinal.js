...
const cardCreate = (data) => {
    for (let y = 0; y < data.length; y++) {
        ...
        if (data[y].tutor_reviews.length > 0) {
            tutorReviews = data[y].tutor_reviews;
        } else {
            tutorReviews = null;
        };
        ...
        if (tutorReviews !== null) {
            for (let s=0; s < tutorReviews.length; s++){
                ...
                if (tutorReviews[s].rating === 0){
                    ...
                    starRating =  `<i class="bi bi-star-fill"></i><i class="bi bi-star-fill"><i class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i>`
                }else if (tutorReviews[s].rating === 3){
                    starRating = `<i class="bi bi-star-fill"></i><i class="bi bi-star-fill"><i class="bi bi-star-fill"></i><i class="bi bi-star"></i><i class="bi bi-star"></i>`
                }else if (tutorReviews[s].rating === 4){
                    starRating =  `<i class="bi bi-star-fill"></i><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star"></i>`
                } else if (tutorReviews[s].rating === 5){
                    starRating =  `<i class="bi bi-star-fill"></i><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">`
                } else {
                    ...
                    <div class="tab-content" id="${tutorName}-tabPanels">
                            ...
                            <div class="SIDE-BY-SIDE-CONTAINER-LOCATION-INTERESTS row">
                                ...
                                <div class="text-center mt-2">
                                    <div class="EXTRA-CERTIFICATIONS">
                                        ...
                                        <p class="LIST-CERTIFICATIONS-HERE text-muted">${certifications}
                                        </p>
                                    </div>
                        ...
                        <div class="tab-pane fade p-2" id="${tutorName}-contactTabContent" role="tabpanel"
                            ...
                            <div class="CONTACT-PHONE-NUMBER row">
                                ...
                                <p class="text-muted col">${phoneNumber}</br>
                                </p>
                            </div>
                        </div>
                    </div>
